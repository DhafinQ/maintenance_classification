...
@router.get("/{machine_id}", dependencies=[Depends(get_current_user)])
...
@router.put("/{machine_id}", dependencies=[Depends(get_current_user)])
...
@router.delete("/{machine_id}", dependencies=[Depends(get_current_user)])
